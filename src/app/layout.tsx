...
export const metadata: Metadata = {
  ...
  description: "Astrology guidance of Pandit Rahul Bali Ji, providing personalized horoscopes, astrology readings, and spiritual consultations. Align with fortune and truth.",
};
