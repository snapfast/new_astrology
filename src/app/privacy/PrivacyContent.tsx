...
const TRANSLATIONS = {
  en: {
    ...
    list3: [
      { title: "Calendly:", text: " Used exclusively for secure appointment bookings." },
      { title: "Google Analytics:", text: " Collects anonymous usage trends to optimize the speed and reach of our services." },
      { title: "Donations:", text: " UPI QR Codes and PayPal integrations are processed directly by the respective financial gateways; no payment credentials or card details are ever stored on our servers." }
    ],
