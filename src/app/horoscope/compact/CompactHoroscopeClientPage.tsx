        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4 text-xs">
            <div className="flex gap-2">
              <span className="text-on-surface/80 font-label uppercase tracking-tighter">{t.name}:</span>
              <span className="font-bold">{name}</span>
            </div>
            <div className="flex gap-2">
              <span className="text-on-surface/80 font-label uppercase tracking-tighter">{t.date}:</span>
              <span className="font-bold">{formattedDob}</span>
            </div>
            <div className="flex gap-2">
              <span className="text-on-surface/80 font-label uppercase tracking-tighter">{t.time}:</span>
              <span className="font-bold">{tob}</span>
            </div>
            <div className="flex gap-2 max-w-[200px] truncate">
              <span className="text-on-surface/80 font-label uppercase tracking-tighter">{t.place}:</span>
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={i} className="flex flex-col">
                  <span className="text-[9px] text-on-surface/90 font-label uppercase tracking-tighter leading-none mb-1">{item.label}</span>
              ...
              <table className="w-full text-left border-collapse">
                <thead className="sticky top-0 bg-white shadow-sm z-10">
                  <tr className="border-b border-outline/30">
                    <th className="px-2 py-1.5 text-[9px] font-bold text-on-surface/90 uppercase font-label">{t.planet}</th>
                    <th className="px-1 py-1.5 text-[9px] font-bold text-on-surface/90 uppercase font-label text-center">{t.house}</th>
                    <th className="px-2 py-1.5 text-[9px] font-bold text-on-surface/90 uppercase font-label">{t.rasi}</th>
                    <th className="px-2 py-1.5 text-[9px] font-bold text-on-surface/90 uppercase font-label">{t.degree}</th>
                    <th className="px-2 py-1.5 text-[9px] font-bold text-on-surface/90 uppercase font-label">{t.nakshatra}</th>
                  </tr>
                </thead>
