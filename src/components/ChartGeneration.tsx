          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  name="name"
                  className="w-full px-6 py-4 bg-surface-container-low border border-outline rounded-2xl focus:ring-1 focus:ring-accent/20 placeholder:text-secondary/30 text-on-surface text-sm"
              ...
              <div className="space-y-2">
                ...
                <input
                  name="dob"
                  className="w-full px-6 py-4 bg-surface-container-low border border-outline rounded-2xl focus:ring-1 focus:ring-accent/20 text-on-surface text-sm"
                  type="date"
                  required
                />
              </div>
