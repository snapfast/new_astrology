  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="flex min-h-full items-center justify-center p-4 pointer-events-none">
        <div className="relative w-full max-w-lg md:max-w-3xl bg-white rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl animate-in fade-in zoom-in duration-500 border border-white/20 pointer-events-auto flex flex-col">
          <div className="p-4 md:p-8 flex-1">
          <div className="flex justify-center items-center mb-6 md:mb-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <button
              onClick={onBookNow}
              className="p-5 md:p-6 bg-surface-bright border border-outline/10 rounded-[2.5rem] text-left"
            >
              <div className="flex flex-col h-full">
                ...
                <p className="text-xs md:text-sm text-secondary/70 font-body leading-relaxed mb-4 md:mb-6 flex-1">
            ...
            <a
              href="/contact"
              className="p-5 md:p-6 bg-surface-bright border border-outline/10 rounded-[2.5rem]"
            >
              <div className="flex flex-col h-full">
                <div className="flex justify-between items-start mb-4 md:mb-6">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-accent/5 flex items-center justify-center text-accent">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-4 mt-6 md:mt-8">
            ...
            <a
              ...
              className="block p-2 md:p-4 bg-surface-container-low/30 border border-outline/5 rounded-2xl md:rounded-[1.5rem] text-center"
            >
          ...
          <div className="mt-6 md:mt-8 pt-6 border-t border-outline/10 text-center">
