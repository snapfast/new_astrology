...
const SocialGallery = () => {
  // Logic to refresh embeds when they are injected
  useEffect(() => {
  ...
  return (
    <section className="py-32 bg-background border-t border-outline/10">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-6xl font-normal font-headline text-on-surface tracking-tight leading-tight">
              Latest Findings & <br />Celestial Wisdom
            </h2>
          </div>
        ...
        <div className="mt-20 text-center">
          <p className="text-secondary text-sm font-body mb-8">Follow for more daily insights and astrological findings.</p>
