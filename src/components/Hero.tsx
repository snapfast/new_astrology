      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 text-center mt-12">
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-12 max-w-lg mx-auto pt-8 border-t border-outline/20">
          <div className="flex flex-col items-center border-r border-outline/20">
            ...
            <span className={`text-[8px] md:text-[10px] font-medium text-on-surface uppercase font-label ${lang === 'en' ? 'tracking-[0.2em]' : ''}`}>{t.charts}</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-xl md:text-2xl font-headline text-on-surface">5/5</span>
            <span className={`text-[8px] md:text-[10px] font-medium text-on-surface uppercase font-label ${lang === 'en' ? 'tracking-[0.2em]' : ''}`}>{t.rating}</span>
          </div>
        </div>
      </div>
