  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-y-auto custom-scrollbar">
      ...
      <div className="flex min-h-full items-center justify-center p-4 pointer-events-none">
        <div className="relative w-full max-w-lg md:max-w-2xl bg-white/90 backdrop-blur-xl rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl animate-in fade-in zoom-in duration-500 border border-white/20 pointer-events-auto">
