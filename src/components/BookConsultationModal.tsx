  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="flex min-h-full items-center justify-center p-4 pointer-events-none">
        <div className="relative w-full max-w-lg md:max-w-2xl bg-white rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl animate-in fade-in zoom-in duration-500 border border-white/20 pointer-events-auto flex flex-col">
          <div className="p-4 md:p-8 flex-1">
          <div className="flex justify-center items-center mb-6 md:mb-8 relative">
            <h2 className="text-xl md:text-3xl font-normal text-on-surface font-headline tracking-tight text-center">Book Consultation</h2>
            <button
              onClick={onClose}
          ...
          <div className="space-y-6 md:space-y-10">
            <div className="flex flex-col items-center text-center">
              <div className="mb-4 md:mb-6 p-5 md:p-8 bg-surface-container-low/20 rounded-[2.5rem] border border-outline/5">
                <svg viewBox="0 0 122.88 101.11" className="w-10 h-10 md:w-12 md:h-12">
                  <g>
              ...
              <h3 className="text-lg md:text-2xl font-normal text-on-surface font-headline mb-2">Personal Consultation</h3>
              <div className="space-y-1 md:space-y-2">
                <p className="text-[12px] md:text-lg text-secondary font-body">30-minute session via Google Meet</p>
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="p-3 md:p-5 bg-surface-container-low/40 rounded-2xl md:rounded-3xl border border-outline/5 text-center">
                <p className="text-[9px] md:text-sm text-secondary/70 font-body leading-relaxed max-w-sm mx-auto">
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="w-full py-3 md:py-5 border border-accent/30 rounded-full text-accent font-label text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase text-center bg-accent/5"
                >
                  View Payment QR
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 w-full py-4 md:py-6 bg-primary text-white text-center rounded-full font-medium text-xs md:text-sm tracking-[0.15em] uppercase shadow-xl shadow-primary/10"
                >
                  Proceed to Calendly
                </a>
              </div>
          ...
          <div className="mt-4 md:mt-8 pt-4 md:pt-6 border-t border-outline/10 text-center">
