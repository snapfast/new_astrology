      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-10 rounded-[2rem] group hover:-translate-y-1 transition-all duration-500 border border-slate-100">
            <div className="w-12 h-12 bg-surface-container rounded-full flex items-center justify-center mb-8">
            ...
            <a className="text-on-surface text-[11px] font-semibold tracking-widest uppercase flex items-center gap-2 group-hover:gap-4 transition-all font-label" href="#">
          ...
          <div className="bg-white p-10 rounded-[2rem] group hover:-translate-y-1 transition-all duration-500 shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-slate-100">
            <div className="w-12 h-12 bg-surface-container rounded-full flex items-center justify-center mb-8">
              <span className="material-symbols-outlined text-secondary text-2xl">calendar_view_week</span>
            </div>
