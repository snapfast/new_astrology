    ...
    <footer className="w-full pt-32 pb-20 bg-background border-t border-outline/50 font-body">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 px-8">
        ...
        <div>
          ...
          <ul className="space-y-5 text-sm">
            <li><a className="text-secondary hover:text-accent transition-colors font-light" href="https://www.instagram.com/RahulBaliAstro" target="_blank" rel="noopener noreferrer">Instagram</a></li>
            <li><a className="text-secondary hover:text-accent transition-colors font-light" href="https://www.youtube.com/@RahulBaliAstrology" target="_blank" rel="noopener noreferrer">YouTube</a></li>
            <li><a className="text-secondary hover:text-accent transition-colors font-light" href="https://rahulbaliastrology.tumblr.com/" target="_blank" rel="noopener noreferrer">Tumblr</a></li>
          </ul>
        </div>
        <div>
          <h6 className="text-on-surface mb-8 text-[10px] font-semibold tracking-widest uppercase font-label">Company</h6>
          <ul className="space-y-5 text-sm">
            <li><a className="text-secondary hover:text-accent transition-colors font-light" href="/about">About Us</a></li>
            <li><a className="text-secondary hover:text-accent transition-colors font-light" href="/contact">Contact</a></li>
            <li><a className="text-secondary hover:text-accent transition-colors font-light" href="/donate">Donate</a></li>
          </ul>
        </div>
      </div>
