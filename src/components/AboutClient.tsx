...
const TRANSLATIONS = {
  en: {
    para1: {
      text1: "Pandit Rahul Bali Ji provides practical life guidance through ",
      strong: "Jyotish Shastra",
      text2: ". His approach combines traditional astrology with psycho-analysis, focusing on understanding deep-rooted thinking patterns and behaviors. By decoding your birth chart, he offers clear, actionable insights to help you navigate your career, relationships, and personal growth."
    },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-16 items-start">
        ...
        <div className="lg:col-span-6 space-y-16">
          <div className="prose prose-lg max-w-none font-body text-on-surface leading-relaxed space-y-8">
            <p>{t.para1.text1}<strong>{t.para1.strong}</strong>{t.para1.text2}</p>
